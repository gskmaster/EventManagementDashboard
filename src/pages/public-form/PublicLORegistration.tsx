          ...
          <div className="p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-4 border-t border-slate-100">
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-xl hover:border-teal-400 transition-colors group cursor-pointer">
                  <div className="space-y-1 text-center">
                    <FileText className="mx-auto h-10 w-10 text-slate-400 group-hover:text-teal-500 transition-colors" />
